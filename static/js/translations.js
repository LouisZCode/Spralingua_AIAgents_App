...
const translations = {
    english: {
        ...
        writing_practice_desc: "Improve your written communication skills",
    ...
    german: {
        ...
        writing_practice_desc: "Verbessere deine schriftlichen Kommunikationsfähigkeiten",
    ...
    spanish: {
        ...
        writing_practice_desc: "Mejora tus habilidades de comunicación escrita",
    ...
    portuguese: {
        ...
        writing_practice_desc: "Melhore suas habilidades de comunicação escrita",
