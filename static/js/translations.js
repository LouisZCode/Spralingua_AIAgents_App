...
const translations = {
    english: {
        ...
        messages_in_language: "{count}/6 messages in {language} sent",
    ...
    german: {
        ...
        messages_in_language: "{count}/6 Nachrichten auf {language} gesendet",
    ...
    spanish: {
        ...
        messages_in_language: "{count}/6 mensajes en {language} enviados",
    ...
    portuguese: {
        ...
        messages_in_language: "{count}/6 mensagens em {language} enviadas",
